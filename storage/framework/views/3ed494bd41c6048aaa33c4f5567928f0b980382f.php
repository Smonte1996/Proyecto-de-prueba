         ...
         <nav class="flex gap-2 items-center">
            <a href="<?php echo e(route('posts.create')); ?>" class="flex items-center gap-2 bg-white border p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    Crear</a>
            <a href="<?php echo e(route('pots.index', auth()->user()->username)); ?>" class="font-bold uppercase text-gray-600 text-sms">Hola <span class="font-normal"><?php echo e(auth()->user()->username); ?></span> </a> |
